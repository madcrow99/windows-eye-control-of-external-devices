    ...
    public sealed partial class misc : Page
    {
        ...
        private void MyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (button != null)
            {
                ...
                if (button.Name == "KeyLatchCommand")
                {
                    if (latch_active == false)
                    {
                        latch_active = true;
                        //change background color to green
                        KeyLatchCommand.Background = new SolidColorBrush(Windows.UI.Colors.Green);
                        KeyLatchCommand.Content = "Latch Active";
                    }
                    else
                    {
                        latch_active = false;
                        //change background color to transparent
                        KeyLatchCommand.Background = new SolidColorBrush(Windows.UI.Colors.Transparent);
                        KeyLatchCommand.Content = "Latch Inactive";
                    }
                }
            }
        }
        ...
        private void roblox_Click(object sender, RoutedEventArgs e)
        {
            commandMapper.Close();
            this.Frame.Navigate(typeof(roblox));
        }
        // Clean up resources
